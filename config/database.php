    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database'  => env('DB_DATABASE', 'pokerinlondon'),
        ...
        //     'database'  => env('DB_DATABASE', env('OPENSHIFT_APP_NAME', 'pokerinlondon')),
        //     'username'  => env('DB_USERNAME', env('OPENSHIFT_MYSQL_DB_USERNAME', 'adminJm2cxMY')),
        //     'password'  => env('DB_PASSWORD', env('OPENSHIFT_MYSQL_DB_PASSWORD', 'yH9vNbF_85cJ')),
        //     'charset'   => 'utf8',
        //     'collation' => 'utf8_unicode_ci',
        //     'prefix'    => '',
        //     'strict'    => false,
