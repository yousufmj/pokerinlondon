<ul id="menu" class="page-sidebar-menu">
    ...
    <li {!! (Request::is('admin/cash') ? 'class="active"' : '') !!}>
        <a href="{{ route('cash') }}">
            <i class="livicon" data-name="money" data-size="18" data-c="#F89A14" data-hc="#F89A14"
               data-loop="true"></i>
            <span class="title">Manage Cash Games</span>
        </a>
    </li>
    <li {!! (Request::is('admin/tournaments') ? 'class="active"' : '') !!}>
        <a href="{{ route('dashboard') }}">
            <i class="livicon" data-name="table" data-size="18" data-c="#6CC66C" data-hc="#6CC66C"
               data-loop="true"></i>
            <span class="title">Manage Tournaments</span>
        </a>
    </li>
    <li {!! (Request::is('admin/social-media') ? 'class="active"' : '') !!}>
        <a href="{{ route('dashboard') }}">
            <i class="livicon" data-name="twitter" data-size="18" data-c="#67C5DF" data-hc="#67C5DF"
               data-loop="true"></i>
            <span class="title">My Social Media</span>
        </a>
    </li>
